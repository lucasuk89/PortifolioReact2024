    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <p className="sub-title">Ui/UX Design Content</p>
          <h2 className="section--heading">Figma Projects and Concepts </h2>
        </div>
        <div>
          <button className="btn btn-github" onClick={handleFigma}>
            <svg
